...
gdjs.GameOverCode.GDSubmitLoaderObjects4= [];
...
gdjs.GameOverCode.GDMenuButtonObjects1= [];
gdjs.GameOverCode.GDMenuButtonObjects2= [];
gdjs.GameOverCode.GDMenuButtonObjects3= [];
gdjs.GameOverCode.GDMenuButtonObjects4= [];
...
gdjs.GameOverCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9394788);
}
}if (gdjs.GameOverCode.condition0IsTrue_0.val) {
}
...
};gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDRestartButtonObjects3Objects = Hashtable.newFrom({"RestartButton": gdjs.GameOverCode.GDRestartButtonObjects3});
gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDSubmitButtonObjects3Objects = Hashtable.newFrom({"SubmitButton": gdjs.GameOverCode.GDSubmitButtonObjects3});
gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDScoresButtonObjects3Objects = Hashtable.newFrom({"ScoresButton": gdjs.GameOverCode.GDScoresButtonObjects3});
gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDMenuButtonObjects2Objects = Hashtable.newFrom({"MenuButton": gdjs.GameOverCode.GDMenuButtonObjects2});
...
gdjs.copyArray(runtimeScene.getObjects("RestartButton"), gdjs.GameOverCode.GDRestartButtonObjects3);

gdjs.GameOverCode.condition0IsTrue_0.val = false;
{
gdjs.GameOverCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDRestartButtonObjects3Objects, runtimeScene, true, false);
}if (gdjs.GameOverCode.condition0IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("SubmitButton"), gdjs.GameOverCode.GDSubmitButtonObjects3);
...
}{for(var i = 0, len = gdjs.GameOverCode.GDSubmitButtonObjects3.length ;i < len;++i) {
    gdjs.GameOverCode.GDSubmitButtonObjects3[i].enableEffect("Disabled", false);
}
}}
...
gdjs.GameOverCode.condition1IsTrue_0.val = false;
{
gdjs.GameOverCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDSubmitButtonObjects3Objects, runtimeScene, true, false);
}if ( gdjs.GameOverCode.condition0IsTrue_0.val ) {
{
...
{gdjs.evtTools.leaderboards.savePlayerScore(runtimeScene, "2267e29f-f9c1-4952-abea-ed0bb52f1afa", gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(0)), (( gdjs.GameOverCode.GDPlayerNameInputObjects3.length === 0 ) ? "" :gdjs.GameOverCode.GDPlayerNameInputObjects3[0].getString()));
...
gdjs.copyArray(runtimeScene.getObjects("ScoresButton"), gdjs.GameOverCode.GDScoresButtonObjects3);

gdjs.GameOverCode.condition0IsTrue_0.val = false;
{
gdjs.GameOverCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDScoresButtonObjects3Objects, runtimeScene, true, false);
}if (gdjs.GameOverCode.condition0IsTrue_0.val) {
{gdjs.evtTools.leaderboards.displayLeaderboard(runtimeScene, "2267e29f-f9c1-4952-abea-ed0bb52f1afa", true);
...
gdjs.copyArray(runtimeScene.getObjects("MenuButton"), gdjs.GameOverCode.GDMenuButtonObjects2);

gdjs.GameOverCode.condition0IsTrue_0.val = false;
{
gdjs.GameOverCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.GameOverCode.mapOfGDgdjs_46GameOverCode_46GDMenuButtonObjects2Objects, runtimeScene, true, false);
}if (gdjs.GameOverCode.condition0IsTrue_0.val) {
...
gdjs.GameOverCode.condition0IsTrue_0.val = false;
{
gdjs.GameOverCode.condition0IsTrue_0.val = gdjs.evtTools.input.isKeyPressed(runtimeScene, "r");
}if (gdjs.GameOverCode.condition0IsTrue_0.val) {
...
gdjs.GameOverCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9373748);
}
}}
if (gdjs.GameOverCode.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("SubmitButton"), gdjs.GameOverCode.GDSubmitButtonObjects2);
...
{
{gdjs.GameOverCode.conditionTrue_1 = gdjs.GameOverCode.condition1IsTrue_0;
gdjs.GameOverCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9374324);
}
}}
if (gdjs.GameOverCode.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("SubmitButton"), gdjs.GameOverCode.GDSubmitButtonObjects2);
...
{
{gdjs.GameOverCode.conditionTrue_1 = gdjs.GameOverCode.condition1IsTrue_0;
gdjs.GameOverCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9375308);
}
}}
if (gdjs.GameOverCode.condition1IsTrue_0.val) {
...
gdjs.GameOverCode.GDSubmitLoaderObjects4.length = 0;
...
gdjs.GameOverCode.GDMenuButtonObjects1.length = 0;
gdjs.GameOverCode.GDMenuButtonObjects2.length = 0;
gdjs.GameOverCode.GDMenuButtonObjects3.length = 0;
gdjs.GameOverCode.GDMenuButtonObjects4.length = 0;
